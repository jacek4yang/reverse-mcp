...
fn main() {
    ...
    #[cfg(target_os = "windows")]
    {
        builder
            ...
            .define("__NT__", "1")
            .define("__EA64__", "1")
            // `under_debugger` is a DATA export of ida.dll read by the QASSERT
            // macro (INTERR); generated wrappers for inlines like
            // processor_t::get_proc_index() pull it in and data imports cannot
            // be delay-loaded (LNK1194). Rename every reference to a local
            // definition (idasdk_extras.h): assertions still report through
            // interr(), they just never breakpoint.
            .define("under_debugger", "rmcp94_under_debugger")
            .compile("libida-stubs");
